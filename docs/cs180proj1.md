...
<h2 style="text-align:center">CS180, Fall 2024</h2>
...
All of the images above have a bit of uneven borders that are not part of the image. So I attempted to implement a way to autodetect and autocrop them.
